...
class HelpersTest(TestCase):
    ...
    @mock.patch("task_ai.app.handlers.helpers.client.beta.threads.messages.create")
    @mock.patch("task_ai.app.handlers.helpers.client.beta.threads.runs.create")   
    def test_handle_run_creation_invalid_type(self, mock_runs_create, mock_messages_create):
        mock_runs_create.return_value = MockRun("run_id")
        mock_messages_create.return_value = "Message created"
        p_type = "unknown"
        prompt = "this is a valid test prompt"
    ...
    @mock.patch("task_ai.app.handlers.helpers.client.beta.threads.messages.create")
    @mock.patch("task_ai.app.handlers.helpers.client.beta.threads.runs.create")   
    def test_handle_run_creation_empty_prompt(self, mock_runs_create, mock_messages_create):
        mock_runs_create.return_value = MockRun("run_id")
        mock_messages_create.return_value = "Message created"
        p_type = "unknown"
        prompt = "this is a valid test prompt"
    ...
    @mock.patch("task_ai.app.handlers.helpers.client.beta.threads.messages.create")
    @mock.patch("task_ai.app.handlers.helpers.client.beta.threads.runs.create")   
    def test_handle_run_creation_create_message_error(self, mock_runs_create, mock_messages_create):
        mock_runs_create.return_value = MockRun("run_id")
    ...
    @mock.patch("task_ai.app.handlers.helpers.client.beta.threads.messages.create")
    @mock.patch("task_ai.app.handlers.helpers.client.beta.threads.runs.create")   
    def test_handle_run_creation_create_run_error(self, mock_runs_create, mock_messages_create):
        mock_runs_create.return_value = MockRun("run_id")
        mock_messages_create.side_effect = ValueError("An error occurred")
        p_type = "unknown"
        prompt = "this is a valid test prompt"
